MCU=atmega328p
F_CPU=16000000UL
CC=/root/.arduino15/packages/arduino/tools/avr-gcc/7.3.0-atmel3.6.1-arduino7/bin/avr-g++
OBJCOPY=avr-objcopy
...
SRCS=sonar.cpp
all:
	${CC} ${CFLAGS} -o ${TARGET}.bin ${SRCS} -I./src -I/home/alex/tmp/arduino/sonar/arduino -I./standard NewPing.cpp core.a
